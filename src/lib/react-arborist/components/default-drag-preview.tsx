import { CSSProperties, memo, type ReactElement, type ReactNode } from "react";
import { XYCoord } from "../types/dnd";
...
function Position(props: { children: ReactElement; offset: XYCoord | null }) {
  return (
