...
export const actions = {
  ...
  setHybridDragActive(active: boolean) {
    return { type: "DND_SET_HYBRID_DRAG_ACTIVE" as const, active };
  },
};
...
export function reducer(
  ...
  switch (action.type) {
    ...
    case "DND_SET_HYBRID_DRAG_ACTIVE":
      return { ...state, hybridDragActive: action.active };
    default:
      return state;
  }
}
