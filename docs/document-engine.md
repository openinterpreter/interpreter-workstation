...
Rich embedded editing is an optional integration. A compatible document engine
can be configured by a distribution and installed independently. The community
source does not bundle a paid SDK, license file, or proprietary conversion
runtime.
